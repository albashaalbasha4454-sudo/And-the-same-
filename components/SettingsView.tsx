    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div className="bg-white shadow-lg rounded-xl p-6">
            ...
            <div className="p-4 bg-red-100 border-r-4 border-red-600 text-red-900 rounded-md mt-10">
                <p className="font-bold flex items-center gap-2 text-red-600"><span className="material-symbols-outlined">dangerous</span> تصفير النظام الشامل</p>
                <p className="text-sm mt-1">
                هذا الإجراء سيطلب حذف جميع البيانات نهائياً. يتطلب موافقات أمنية متعددة.
                </p>
                <button 
                    onClick={onOpenReset}
                    className="mt-4 w-full bg-red-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-red-700 transition-colors flex items-center justify-center gap-2"
                >
